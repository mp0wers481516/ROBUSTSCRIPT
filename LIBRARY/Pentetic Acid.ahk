...
CHEM_DISPENSER(+20, "Hydrogen") ;not case sensitive
...
USE_HANDS()
MOUSE_JUMPTO("OTHER HAND", 13) ;not case sensitive
USE_HANDS()
MOUSE_JUMPTO("POCKET 1")
SWAP_HANDS()
...
CHEM_DISPENSER(-60, "Cyanide & Formaldehyde") ;"Cyanide & Formaldehyde" can be omitted
CHEM_DISPENSER(+5, "Nitrogen")
CHEM_DISPENSER(+15, "Hydrogen")
CHEM_DISPENSER(+15, "Welding Fuel")
CHEM_DISPENSER(+15, "Chlorine")
CHEM_DISPENSER(+15, "Sodium")
